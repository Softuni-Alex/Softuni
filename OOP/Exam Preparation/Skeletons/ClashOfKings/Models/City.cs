namespace ClashOfKings.Models
{
    ...
    public class City : ICity
    {
        ...
        private static readonly string CityNamePattern = $@"[a-zA-Z\-]{{{MinCityNameLength},{MaxCityNameLength}}}";
        ...
        public string Name
        {
            ...
            private set
            {
                if (value == null)
                {
                    throw new ArgumentNullException(nameof(this.name), EmptyCityNameErrorMessage);
                }

                if (!Regex.IsMatch(value, CityNamePattern))
                {
                    throw new ArgumentException(string.Format(InvalidCityNameErrorMessage,
                        MinCityNameLength,
                        MaxCityNameLength));
                }
        ...
        public int Defense
        {
            ...
            private set
            {
                if (value < 0)
                {
                    throw new ArgumentOutOfRangeException(nameof(this.defense));
                }
        ...
        public decimal UpgradeCost
        {
            ...
            private set
            {
                if (value < 0)
                {
                    throw new ArgumentOutOfRangeException(nameof(this.upgradeCost));
                }
        ...
        public double FoodProduction
        {
            ...
            set
            {
                if (value < 0)
                {
                    throw new ArgumentOutOfRangeException(nameof(this.foodProduction));
                }
        ...
        public decimal TaxBase
        {
            ...
            set
            {
                if (value < 0)
                {
                    throw new ArgumentOutOfRangeException(nameof(this.taxBase));
                }
        ...
        public IEnumerable<IMilitaryUnit> AvailableMilitaryUnits => this.availableMilitaryUnits;
        ...
        public IEnumerable<IArmyStructure> ArmyStructures => this.armyStructures;
        ...
        public virtual string Print()
        {
            ...
            result.AppendFormat(
                "-Army: {0}{1}", 
                string.Join(", ", this.AvailableUnitsByType.Select(u => $"{u.Value} {u.Key}")), 
                Environment.NewLine);
        ...
        private void VerifyHousingSpaces(ICollection<IMilitaryUnit> units)
        {
            ...
            {
                throw new InsufficientHousingSpacesException($"{this.Name} doesn't have enough housing spaces");
            }
        }
        ...
        private void ProvisionArmy()
        {
            ...
            if (starved)
            {
                throw new NotEnoughProvisionsException($"City {this.Name} suffered starvation");
            }
        }
