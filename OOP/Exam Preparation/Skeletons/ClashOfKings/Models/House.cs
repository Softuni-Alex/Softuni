namespace ClashOfKings.Models
{
    ...
    public class House : IHouse
    {
        ...
        private static readonly string HouseNamePattern = $"[a-zA-Z]{{{MinHouseNameLength},{MaxHouseNameLength}}}";
        ...
        public string Name
        {
            ...
            private set
            {
                if (value == null)
                {
                    throw new ArgumentNullException(nameof(this.name), EmptyHouseNameErrorMessage);
                }
        ...
        public IEnumerable<ICity> ControlledCities => this.controlledCities;

        public virtual void UpgradeCity(ICity city)
        {
            if (city == null)
            {
                throw new ArgumentNullException(nameof(city), CityNotFoundErrorMessage);
            }
        ...
        public void RemoveCityFromHouse(string cityName)
        {
            ...
            if (city == null)
            {
                throw new ArgumentNullException(nameof(city), string.Format(CityNotFoundErrorMessage, this.Name));
            }
