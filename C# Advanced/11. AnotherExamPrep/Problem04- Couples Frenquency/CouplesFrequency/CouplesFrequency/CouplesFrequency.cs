...
namespace CouplesFrequency
{
    public class CouplesFrequency
    {
        public static void Main()
        {
            ...
            {
                string currentCouple = string.Format("{0} {1}",
            ...
            {
                double percentage = coupleFrequency.Value * 100.0 / totalNumberOfCouples;
                Console.WriteLine("{0} -> {1:F2}%", coupleFrequency.Key, percentage);
            }
        }
    }
}