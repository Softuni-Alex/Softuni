namespace AirConditioner.Utilities
{
    public static class Constants
    {
        public const string IncorrectManufactoryLength = "{0}'s name must be at least {1} symbols long.";
        public const string IncorrectModelLength = "{0}'s name must be at least {1} symbols long.";
        public const string NoReports = "No reports.";
        public const string InvalidCommand = "Invalid command";
        public const string Status = "Jobs complete: {0:F2}%";
        public const string IncorectRating = "Energy efficiency rating must be between \"A\" and \"E\".";
