    ...
    public class Minesweeper
    {
        ...
        private static void Main()
        {
            ...
            do
            {
                ...
                {
                    Console.WriteLine(
                        "Hajde da igraem na “Mine”. Probvai si kusmeta da otkriesh poleteta bez minichki."
                        + " Komanda 'top' pokazva klasiraneto, 'restart' pochva nova igra, 'exit' izliza!");
                    dumpp(gameField);
                    flag = false;
                }

                Console.Write("Podai red i kolona : ");
                ...
                {
                    dumpp(mines);
                    Console.Write("\nHrrrrrr! Umria s {0} to4ki. " + "Enter nickname: ", counter);
                ...
                if (flag2)
                {
                    Console.WriteLine("\nNICE! Otvori 35 kletki bez kapka kryv.");
                    dumpp(mines);
